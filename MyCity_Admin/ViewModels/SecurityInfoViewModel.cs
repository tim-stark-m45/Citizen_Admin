...
{
    class SecurityInfoViewModel : ViewModelBase
    {
        private Security security;
        public Security Security { get => security; set => Set(ref security, value); }
            ...
            AppDbContext db)
        {
            ...
            Messenger.Default.Register<SendSecurity>(this, msg =>
            {
                Security = msg.Data;
