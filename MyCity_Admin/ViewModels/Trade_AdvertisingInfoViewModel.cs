...
{
    class Trade_AdvertisingInfoViewModel : ViewModelBase
    {
        private Trade_Advertising trade_Advertising;
        ...
        public Trade_AdvertisingInfoViewModel(
            ...
            AppDbContext db)
        {
            ...
            Messenger.Default.Register<SendTrade_Advertising>(this, msg =>
            {
                Trade_Advertising = msg.Data;
